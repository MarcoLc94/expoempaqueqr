      ...
      <div className="glass-card">
        ...
        <div className="card-content">
          ...
          <h1 className="title">
            ...
            <span>Expo Empaque QR</span>
          </h1>
          <p className="description">
            Descubre la nueva forma de escanear e interactuar con empaques. 
            Dado que las tiendas oficiales estarán disponibles próximamente, 
            te ofrecemos acceso directo a las versiones nativas oficiales para tu dispositivo.
          </p>
          ...
          <div className="btn-group">
            ...
            {/* Download iOS */}
            <a href="https://testflight.apple.com/join/placeholder" target="_blank" rel="noopener noreferrer" className="btn btn-ios">
              <svg className="btn-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="terms-note">
            ...
            Para iOS, es posible que requieras de un perfil aprovisionado o instalar vía TestFlight.
          </p>
        ...
        <div className="card-visuals">
          <div className="hero-image-wrapper">
            <svg 
              ...
              style={{ filter: "drop-shadow(0 0 30px rgba(12, 224, 255, 0.4))", width: "100%", height: "100%", maxWidth: "300px" }}
            >
              <defs>
              ...
              <rect x="0" y="0" width="200" height="200" rx="40" fill="rgba(255, 255, 255, 0.05)" stroke="url(#qr-grad)" strokeWidth="4" />
              ...
              <g fill="url(#qr-grad)" filter="url(#neon-glow)">
                ...
                <rect x="75" y="75" width="50" height="50" rx="10" fill="rgba(12, 224, 255, 0.2)" />
                <circle cx="100" cy="100" r="15" fill="none" stroke="url(#qr-grad)" strokeWidth="4" />
              </g>
            </svg>
          </div>
        </div>
